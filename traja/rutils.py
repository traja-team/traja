...
def to_trajr(trj):
    ...
    trajr_trj = trajr.TrajFromCoords(trj_rdf, xCol='x',yCol='y',timeCol=time_col or rpy2.rinterface.NULL, fps=fps or 30, spatialUnits=spatial_units, timeUnits=time_units)
    return trajr_trj
