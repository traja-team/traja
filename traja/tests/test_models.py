...
def test_lstm_jaguar():
    ...
    forecasting_loss_post_training, _, _ = trainer.validate(
...
def test_ae_classification_network_converges():
    ...
    _, _, classification_loss_pre_training = trainer.validate(
        data_loaders["train_loader"]
    )
    ...
    _, _, classification_loss_post_training = trainer.validate(
        data_loaders["train_loader"]
    )
